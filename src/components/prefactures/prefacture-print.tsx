...
interface PrefacturePrintProps {
  prefactura: Prefactura;
}

export function PrefacturePrint({ prefactura }: PrefacturePrintProps) {
    ...
    <div className="facture-print">
      ...
      <div className="facture-header">
        ...
        <div className="facture-title">
          <h1>PRÉFACTURE</h1>
          <div className="facture-numero">{preprefactura.numero}</div>
        </div>
      </div>
      ...
      <div className="parties-info">
        ...
        <div className="partie">
          ...
          <div className="partie-content">
            <div className="name">{prefactura.cliente.razonSocial}</div>
            <div>{prefactura.cliente.direccion}</div>
            {prefactura.cliente.numeroTVA && (
              <div>N° TVA: {prefactura.cliente.numeroTVA}</div>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="facture-meta">
        ...
        {prefactura.referenciaProyecto && (
          <div className="meta-item">
            <strong>Référence Projet:</strong> {prefactura.referenciaProyecto}
          </div>
        )}
        <div className="meta-item">
          <strong>N° Facture:</strong> {prefactura.numero}
        </div>
      </div>
      ...
      <div className="totals-section">
        <table className="totals-table">
          <tbody>
            <tr>
              <td>Montant HT:</td>
              <td>{prefactura.montoHT.toFixed(2)} MAD</td>
            </tr>
            <tr>
              <td>TVA (20%):</td>
              <td>{prefactura.montTVA.toFixed(2)} MAD</td>
            </tr>
            <tr className="total-final">
              <td>Montant TTC:</td>
              <td>{prefactura.montoTTC.toFixed(2)} MAD</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="footer">
        <p>A.L.Y TRAVAUX PUBLIQUE - Préfacture non définitive - Document généré électroniquement</p>
      </div>
    </div>
  );
}
