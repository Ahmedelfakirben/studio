...
export function FactureDetail({ factura }: FactureDetailProps) {
      ...
      <Card>
        <CardHeader className="bg-primary/5">
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-2xl">Facture de Vente</CardTitle>
            ...
            <div>
              ...
              <div className="text-sm space-y-1 text-muted-foreground">
                ...
                {factura.cliente.numeroTVA && (
                  <p>N° TVA: {factura.cliente.numeroTVA}</p>
                )}
              </div>
            </div>
          </div>
            ...
            {factura.referenciaProyecto && (
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="font-medium">{factura.referenciaProyecto}</p>
                </div>
              </div>
            )}
