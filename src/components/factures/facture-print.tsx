...
export function FacturePrint({ factura }: FacturePrintProps) {
    ...
    <div className="facture-print">
      ...
      <div className="facture-header">
        ...
        <div className="facture-title">
          <h1>FACTURE</h1>
          <div className="facture-numero">{factura.numero}</div>
        </div>
      </div>
      ...
      <div className="parties-info">
        ...
        <div className="partie">
          ...
          <div className="partie-content">
            <div className="name">{factura.cliente.razonSocial}</div>
            <div>{factura.cliente.direccion}</div>
            {factura.cliente.numeroTVA && (
              <div>N° TVA: {factura.cliente.numeroTVA}</div>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="facture-meta">
        ...
        {factura.referenciaProyecto && (
          <div className="meta-item">
            <strong>Référence Projet:</strong> {factura.referenciaProyecto}
          </div>
        )}
        <div className="meta-item">
          <strong>N° Facture:</strong> {factura.numero}
        </div>
      </div>
      ...
      <table className="details-table">
        ...
        <tbody>
          {factura.lineasDetalle.map((linea, index) => (
            <tr key={index}>
      ...
      <div className="totals-section">
        <table className="totals-table">
          <tbody>
            <tr>
              <td>Montant HT:</td>
              <td>{factura.montoHT.toFixed(2)} MAD</td>
            </tr>
            <tr>
              <td>TVA (20%):</td>
              <td>{factura.montTVA.toFixed(2)} MAD</td>
            </tr>
            <tr className="total-final">
              <td>Montant TTC:</td>
              <td>{factura.montoTTC.toFixed(2)} MAD</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="total-letras">
        ...
        <div className="total-letras-value">
          {numeroALetras(factura.montoTTC)}
        </div>
      </div>
