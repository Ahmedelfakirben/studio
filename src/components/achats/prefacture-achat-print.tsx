...
interface PrefacturaAchatPrintProps {
    ...
    <div className="facture-print">
      ...
      <div className="facture-meta">
        <div className="meta-item">
          <strong>Date:</strong>{' '}
          {new Date(prefacturaAchat.fecha).toLocaleDateString('fr-FR', {
            day: '2-digit',
            month: 'long',
            year: 'numeric',
          })}
        </div>
        {prefacturaAchat.referenciaProyecto && (
          <div className="meta-item">
            <strong>Référence Projet:</strong> {prefacturaAchat.referenciaProyecto}
          </div>
        )}
        <div className="meta-item">
          <strong>N° Facture:</strong> {prefacturaAchat.numero}
        </div>
      </div>
      ...
      <table className="details-table">
        ...
        <tbody>
          {prefacturaAchat.lineasDetalle.map((linea, index) => (
            <tr key={index}>
      ...
      <div className="totals-section">
        <table className="totals-table">
          <tbody>
            <tr>
              <td>Montant HT:</td>
              <td>{prefacturaAchat.montoHT.toFixed(2)} MAD</td>
            </tr>
            <tr>
              <td>TVA (20%):</td>
              <td>{prefacturaAchat.montTVA.toFixed(2)} MAD</td>
            </tr>
            <tr className="total-final">
              <td>Montant TTC:</td>
              <td>{prefacturaAchat.montoTTC.toFixed(2)} MAD</td>
            </tr>
          </tbody>
        </table>
      </div>
      ...
      <div className="total-letras">
        ...
        <div className="total-letras-value">
          {numeroALetras(prefacturaAchat.montoTTC)}
        </div>
      </div>
