...
interface PrefactureAchatDetailProps {
  prefactura: PrefacturaAchat;
}

export function PrefactureAchatDetail({ prefactura }: PrefactureAchatDetailProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader className="bg-secondary/5">
          <div className="flex items-center justify-between">
            <div>
              <CardTitle className="text-2xl">Préfacture d'Achat</CardTitle>
            ...
            <div>
              ...
              <div className="text-sm space-y-1 text-muted-foreground">
                <p className="font-medium text-foreground">
                  {prefactura.proveedor.razonSocial}
                </p>
                <p>{prefactura.proveedor.direccion}</p>
                {prefactura.proveedor.numeroTVA && (
                  <p>N° TVA: {prefactura.proveedor.numeroTVA}</p>
                )}
              </div>
            </div>

            {/* Información del Cliente (Nosotros) */}
            <div>
              <h3 className="font-semibold mb-2 flex items-center gap-2">
                <Building2 className="h-4 w-4" />
                Client
      ...
      <Card>
        <CardHeader>
          <CardTitle>Détails des Achats</CardTitle>
        </CardHeader>
