...
interface BonLivraisonPrintProps {
  bonLivraison: BonLivraison;
}

export function BonLivraisonPrint({ bonLivraison }: BonLivraisonPrintProps) {
  return (
    <div className="facture-print">
      ...
      <div className="facture-header">
        ...
        <div className="facture-title">
          ...
          <div className="facture-numero">{bonLivraison.numero}</div>
        </div>
      </div>
      ...
      <div className="parties-info">
        ...
        <div className="partie">
          ...
          <div className="partie-content">
            <div className="name">{bonLivraison.cliente.razonSocial}</div>
            <div>{bonLivraison.cliente.direccion}</div>
            {bonLivraison.cliente.numeroTVA && (
              <div>N° TVA: {bonLivraison.cliente.numeroTVA}</div>
            )}
          </div>
        </div>
      </div>
      ...
      <div className="facture-meta">
        ...
        {bonLivraison.referenciaProyecto && (
          <div className="meta-item">
            <strong>Référence Projet:</strong> {bonLivraison.referenciaProyecto}
          </div>
        )}
        <div className="meta-item">
          <strong>N° Bon Livraison:</strong> {bonLivraison.numero}
        </div>
      </div>
      ...
      <table className="details-table">
        ...
        <tbody>
          {bonLivraison.lineasMaterial.map((linea, index) => (
            <tr key={index}>
